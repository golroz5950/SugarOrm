package ir.pearly.sugarorm.util;
...
import ir.pearly.sugarorm.SugarRecord;
import ir.pearly.sugarorm.dsl.Ignore;
import ir.pearly.sugarorm.dsl.Table;
...
public class ReflectionUtil {
    ...
    public static List<Field> getTableFields(Class table) {
        ...
        Log.d("alavi/AlaviSugar", "Fetching properties");
    ...
    public static void addFieldValueToColumn(ContentValues values, Field column, Object object,
        ...
        try {
            ...
            Log.e("alavi/AlaviSugar", e.getMessage());
        }
    }
        ...
        try {
            ...
            if (colName.equalsIgnoreCase("id")) {
                ...
                try {
                    ...
                    Log.e("alavi/AlaviSugar", "Enum cannot be read from Sqlite3 database. Please check the type of field " + field.getName());
                }
            } else
                Log.e("alavi/AlaviSugar", "Class cannot be read from Sqlite3 database. Please check the type of field " + field.getName() + "(" + field.getType().getName() + ")");
    ...
    private static Class getDomainClass(String className, Context context) {
        ...
        if ((discoveredClass != null) &&
            ...
            Log.i("alavi/AlaviSugar", "domain class : " + discoveredClass.getSimpleName());
