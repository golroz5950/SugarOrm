...
import ir.pearly.sugarorm.SugarContext;
...
public class ManifestHelper {
    ...
    public static int getDatabaseVersion(Context context) {
        Integer databaseVersion = SugarContext.getVersion();
    ...
    public static String getDomainPackageName(Context context){
        String domainPackageName = SugarContext.getDomainPakageName();
    ...
    public static String getDatabaseName(Context context) {
        String databaseName = SugarContext.getDbName();
    ...
    public static boolean getDebugEnabled(Context context) {
        ...
        return SugarContext.getQueryLog();
    }
