...
import ir.pearly.sugarorm.dsl.Column;
import ir.pearly.sugarorm.dsl.MultiUnique;
import ir.pearly.sugarorm.dsl.NotNull;
import ir.pearly.sugarorm.dsl.Unique;
import ir.pearly.sugarorm.util.MigrationFileParser;
import ir.pearly.sugarorm.util.NamingHelper;
import ir.pearly.sugarorm.util.NumberComparator;
import ir.pearly.sugarorm.util.QueryBuilder;
import ir.pearly.sugarorm.util.ReflectionUtil;

import static ir.pearly.sugarorm.util.ReflectionUtil.getDomainClasses;
...
public class SchemaGenerator {
    ...
    public static final String SUGAR = "alavi/AlaviSugar";
...
//                }
        ...
        for (String command : alterCommands) {
            Log.i("alavi/AlaviSugar", command);
